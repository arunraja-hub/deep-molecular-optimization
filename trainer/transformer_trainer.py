...
#         print("free_port-" ,str(s.getsockname()[1]))
...
class TransformerTrainer(BaseTrainer):
    ...
    def get_model(self, opt, vocab, device, rank, world_size):
    ...
    def train(self, opt, rank, world_size, free_port, dist_url):
        print("in training")

        # print('torch.distributed.is_nccl_avilable()',dist.is_nccl_avilable())

        # free_port = find_free_port()
        
        setup(rank, world_size, free_port, dist_url)
