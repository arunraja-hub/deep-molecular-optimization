...
echo "training"
python deep_molecular-optimization/train.py --data-path data/chembl_02 --save-directory train_transformer --model-choice transformer --num-epoch 1 transformer
